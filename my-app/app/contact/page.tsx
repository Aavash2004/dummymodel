    ...
    <main className="min-h-screen bg-zinc-50/50 px-6 py-12 sm:py-20 text-zinc-900 dark:bg-zinc-950/50 dark:text-zinc-100">
      <div className="mx-auto max-w-5xl space-y-16">
        ...
        <div className="grid gap-10 lg:grid-cols-12">
          {/* Form Card */}
          <div className="lg:col-span-7 rounded-3xl border border-zinc-200/80 bg-white p-8 shadow-2xs dark:border-zinc-700/60 dark:bg-zinc-950/80">
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full rounded-xl border border-zinc-200 bg-zinc-50/50 p-3 text-sm text-zinc-900 placeholder:text-zinc-400 focus:border-zinc-900 focus:outline-none dark:border-zinc-700/60 dark:bg-zinc-950/80 dark:text-zinc-100 dark:placeholder:text-zinc-500"
                  />
                </div>
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="rounded-3xl border border-zinc-200/80 bg-white p-6 shadow-2xs space-y-4 dark:border-zinc-700/60 dark:bg-zinc-950/80">
